...
//           {roadmap.title}
//         </h1>
//         <p className="text-blue-700 mb-6">{roadmap.introduction}</p>
...
//           </CardHeader>
//           <CardContent>
//             <p className="text-blue-700">{roadmap.goal}</p>
//           </CardContent>
//         </Card>
...
//                   <div className="h-6 w-6 flex-shrink-0 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center text-sm">
//                     {index + 1}
//                   </div>
...
//                       Challenges
//                     </h3>
//                     <p className="text-blue-600">{stage.challenges}</p>
//                   </div>
//                 </div>
...
//         <Button
//           onClick={() => {
//             window.location.href = "/jobPreparation/course";
//           }}
//           className="bg-blue-500 hover:bg-blue-600 flex gap-2 hover:font-bold"
//         >
